...
import { saveSecuritySignature } from "@/app/actions/security";
              ...
              <div className="space-y-6 flex flex-col items-center">
                ...
                <div className="bg-green-50 text-green-800 px-6 py-4 rounded-lg flex items-center justify-between min-w-[300px]">
                  <div>
                    ...
                    <p className="font-mono text-2xl tracking-widest font-bold">{signatureToken}</p>
                  </div>
          ...
          <Card className="w-full max-w-md bg-white">
            ...
            <CardContent>
              ...
              <Input 
                ...
                className="mt-2 text-center tracking-widest font-mono uppercase"
              />
            </CardContent>
